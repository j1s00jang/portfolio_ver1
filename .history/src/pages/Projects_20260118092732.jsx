        ...
        <div className="projects-content-all">
          <div className="projects-folder-container">
            ...
            <div className="projects-tabs">
              <button className="project-tab project-tab-all active">all</button>
              <button className="project-tab project-tab-uiux">ui/ux</button>
              <button className="project-tab project-tab-graphic">graphic design</button>
              <button className="project-tab project-tab-dev">development</button>
            </div>
          </div>
