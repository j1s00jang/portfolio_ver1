        ...
        <div className="about-me-intro">
          <div className="about-me-intro-left">
            <div className="about-me-photo">
              <img 
                src="/src/assets/about_me_images/memoji_jisoo.png" 
                alt="Jisoo's memoji" 
            ...
            <div className="name-title">
              <img 
                src="/src/assets/about_me_images/purple_highlight.png" 
                alt="" 
          ...
          <div className="ilove-content">
            ...
            <div className="ilove-body">
              <div className="ilove-left">
                <img 
                  src="/src/assets/about_me_images/toast.jpg" 
                  alt="My cat Toast" 
              ...
              <div className="ilove-right">
                ...
                <div className="ilove-small-images">
                  <img 
                    src="/src/assets/about_me_images/coffee.jpg" 
                    alt="Coffee" 
                    className="coffee-photo"
                    data-tooltip="My favorite coffee"
                  />
                  <img 
                    src="/src/assets/about_me_images/pudding.jpg" 
                    alt="Pudding I made" 
                    className="baking-photo"
                    data-tooltip="Homemade pudding"
                  />
                  <img 
                    src="/src/assets/about_me_images/traders_joes.jpg" 
        ...
        <div className="about-me-contact">
          <div className="contact-content">
            ...
            <div className="contact-buttons">
              ...
              >
                <img 
                  src="/src/assets/about_me_images/email_icon.svg" 
                  alt="Email icon" 
                  className="contact-icon contact-icon-default"
                />
                <img 
                  src="/src/assets/about_me_images/email_icon_white.svg" 
                  alt="Email icon" 
              ...
              >
                <img 
                  src="/src/assets/about_me_images/linkedin_icon.svg" 
                  alt="LinkedIn icon" 
                  className="contact-icon contact-icon-default"
                />
                <img 
                  src="/src/assets/about_me_images/linkedin_icon_white.svg" 
                  alt="LinkedIn icon" 
                  className="contact-icon contact-icon-hover"
                />
              ...
              <a 
                href="/src/assets/about_me_images/Jisoo_Jang_Resume.pdf" 
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <img 
                  src="/src/assets/about_me_images/resume_icon.svg" 
                  alt="Resume icon" 
                  className="contact-icon contact-icon-default"
                />
                <img 
                  src="/src/assets/about_me_images/resume_icon_white.svg" 
                  alt="Resume icon" 
                  className="contact-icon contact-icon-hover"
                />
              ...
              >
                <img 
                  src="/src/assets/about_me_images/insta_icon.svg" 
                  alt="Instagram icon" 
                  className="contact-icon contact-icon-default"
                />
                <img 
                  src="/src/assets/about_me_images/insta_icon_white.svg" 
                  alt="Instagram icon" 
                  className="contact-icon contact-icon-hover"
                />
