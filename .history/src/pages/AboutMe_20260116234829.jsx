          ...
          <div className="ilove-content">
            ...
            <div className="ilove-body">
              <div className="ilove-left">
                <div className="ilove-cat">
                 <img src="/src/assets/images/toast.jpeg" alt="I love cat" className="ilove-cat-image" />
                </div>
              </div>
              <div className="ilove-right">
                <p className="ilove-list">
                  my cat(Toast, 1y), coffee, food, dessert, home<br />
                  baking, cafe, crochet, hand embroidery,<br />
