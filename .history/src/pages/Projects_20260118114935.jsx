      ...
      <div className="projects-content">
        <div className="projects-content-all">
          <div className="projects-folder-container">
            ...
            />
            <button 
              className="project-tab-clickable project-tab-all-click"
              onClick={() => handleTabClick('all')}
              aria-label="Show all projects"
            />
            <button 
              className="project-tab-clickable project-tab-uiux-click"
              onClick={() => handleTabClick('ui/ux')}
              aria-label="Filter by UI/UX projects"
            />
            <button 
              className="project-tab-clickable project-tab-graphic-click"
              onClick={() => handleTabClick('graphic design')}
              aria-label="Filter by Graphic Design projects"
            />
            <button 
              className="project-tab-clickable project-tab-dev-click"
